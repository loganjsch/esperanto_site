...
vTPM CA — you're trusting Google, AWS, or Azure's attestation of the virtualized TPM.
...
This means there are no long-lived signing keys that can be stolen. Every policy approval is attributable to a specific authenticated identity, and the approval is public and auditable — useful as compliance evidence.
